...
public class LibraryTest {
    ...
    void testAddItem() {
        ...
        assertFalse(library.add(item1));
    }
    @Test
    void testRemoveItem() {
        library.add(item1);
        assertTrue(library.remove(item1));
        assertFalse(library.remove(item2));
    }
    @Test
    ...
    void testLendItem() {
        ...
        assertFalse(library.lendItem(patron, item1));
        assertFalse(library.lendItem(patron, item2));
    }
    @Test
    void testReturnItem() {
        library.add(item1);
        ...
        assertNull(library.returnItem(patron, item1));
    }
}